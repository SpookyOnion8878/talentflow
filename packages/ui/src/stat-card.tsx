  ...
  return (
    <div className="rounded-xl border border-border bg-surface p-5 shadow-card transition-shadow hover:shadow-card-hover">
      <div className="flex items-center justify-between gap-2">
        <p className="text-[13px] font-medium text-text-mid">{label}</p>
        {hint && (
          <span
      ...
      <p className="mt-1.5 text-[30px] font-semibold leading-none tracking-tight text-text-hi tabular-nums">
        {value}
      </p>
    </div>
  );
